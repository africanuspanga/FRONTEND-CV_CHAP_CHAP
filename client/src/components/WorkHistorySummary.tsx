  ...
  return (
    <div className="my-4">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Work history summary</h2>
        <Button 
          variant="outline"
          size="sm"
          className="text-blue-600 border-blue-200 bg-blue-50 h-8 px-3 py-1 rounded"
        >
      ...
      <div className="space-y-4">
        {workExperiences.length > 0 ? (
          workExperiences.map((job, index) => (
            <div key={job.id} className="border rounded-lg shadow-sm">
              <div className="p-4">
                ...
                <div className="mt-4">
                  ...
                  {(job.achievements?.length || 0) > 2 && (
                    <button className="text-blue-600 text-sm flex items-center mt-3">
